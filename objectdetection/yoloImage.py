...
def findObjects(outputs,img):
    ...
    if numSeat>3:
        numSeat=3
    cv2.putText(img, f'Occupied:{numPer}', (10,25),cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 255), 2)
    cv2.putText(img, f'Empty:{numSeat}', (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 255), 2)

    print(f'Occupied:{numPer}')
    print(f'Empty:{numSeat}')
# img = cv2.imread('filled_seat_2.jpg')
img = cv2.imread('empty_seat_3.jpg')
